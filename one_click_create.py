...
from music_contract import (
    VIDEO_STYLE_MUSIC_PROFILES,
    MusicContract,
    _collect_script_music_signals,
...
from generation_controls import (
    ...
    _get_cost_budget_limit,
    _auto_downgrade_enabled,
    apply_low_cost_generation_policy,
    save_template,
    load_template,
)
from clip_contracts import (
    _hash_reference_images,
    _ref_image_values,
    _clip_manifest_path,
...
from quality_contracts import (
    ...
    _NARRATIVE_FIDELITY_MAP,
    _NARRATIVE_HUMAN_FIDELITY_MAP,
    _get_fidelity_for_narrative,
    _get_human_fidelity_for_narrative,
